...
mod tests {
    ...
    fn content_does_not_overlap_borders() {
        ...
        tree.entries = vec![
            FileEntry {
                path: std::path::PathBuf::from("a_very_long_file_name_that_could_overlap_borders_if_not_handled_properly.rs"),
                display: "a_very_long_file_name_that_could_overlap_borders_if_not_handled_properly.rs".into(),
            }
        ];
