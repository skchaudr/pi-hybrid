...
## Corpus Check
- 62 files · ~52,768 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1573 nodes · 3152 edges · 57 communities (56 shown, 1 thin omitted)
...
## Knowledge Gaps
- **276 isolated node(s):** `Default`, `Option`, `PromptMessage`, `ToolCallResponse`, `TokenUsage` (+271 more)
